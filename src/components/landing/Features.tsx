...
const Features = () => {
  ...
  return (
    <section id="how-it-works" className="section container bg-white py-16">
      ...
      <div className="flex flex-col md:flex-row flex-nowrap justify-between items-start gap-4 lg:gap-6 fade-in-up relative mt-12 w-full max-w-6xl mx-auto px-4 overflow-x-auto">
